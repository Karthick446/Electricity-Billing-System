...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title"><font color="red">List of Connection Bills</font></h3>
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-0 px-1 text-end"><font color="green"><?php echo date("Y-m-d H:i",strtotime($row['date_created'])) ?></font></td>
                    <td class="py-0 px-1"><font color="darkblue"><?php echo date("M Y",strtotime($row['month_from'])).' - '.date("M Y",strtotime($row['month_to'])) ?></font></td>
                    <td class="py-0 px-1 lh-1"><font color="megenta">
                        <span class="fw-bold"><?php echo $row['code'] ?></span><br>
                        <span class="fw-light"><?php echo $row['fullname'] ?></span>
                    </font></td>
                    <td class="py-0 px-1 text-end"><font color="bleachedalmond"><?php echo number_format($row['amount'],2) ?></font></td>
                    ...
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item delete_data" data-id = '<?php echo $row['bill_id'] ?>' href="javascript:void(0)">Delete</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
