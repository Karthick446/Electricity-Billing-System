...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Electric Billing Management System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <font color="yellow">Electricity Billing System</font></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'home')? 'active' : '' ?>" aria-current="page" href="./"><font color="cyan">Home</font></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'Clients')? 'active' : '' ?>" href="./?page=Clients"><font color="cyan">Clients</font></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'connections')? 'active' : '' ?>" aria-current="page" href="./?page=connections"><font color="cyan">Connections</font></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'bills')? 'active' : '' ?>" aria-current="page" href="./?page=bills"><font color="cyan">Billings</font></a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'admin')? 'active' : '' ?>" aria-current="page" href="./?page=admin"><font color="cyan">Users</font></a>
                    </li>
                    <?php endif; ?>
